...
class Session
{
    ...
    public function start()
    {
        ...
        if (empty($this->_sessionId) || !is_file($this->_savePath . '/' . $_COOKIE[MEEPO_PS_HTTP_SESSION_NAME])) {
            ...
            return Http::setCookie(MEEPO_PS_HTTP_SESSION_NAME, $this->_sessionId, ini_get('session.cookie_lifetime'),
                ini_get('session.cookie_path'), ini_get('session.cookie_domain'), ini_get('session.cookie_secure'),
